...
public class Game {
    ...
    private String gameDifficultyName; // String that contain the game Difficulty Name
    ...
    Game(int gameMode, int gameDifficulty, Level levelObj) {
        ...
        this.totalAttempts = 0;
        this.totalScore = levelObj.getLevel()*1000;
    }

    // Getters Definition.
    public String getGameModeName() {return gameModeName;}
    public String getGameDifficultyName() {return gameDifficultyName;}
    public int getLivesNum() {return livesNum;}
